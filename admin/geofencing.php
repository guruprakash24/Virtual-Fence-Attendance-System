...
<html lang="en">
    <head>        
        <!-- META SECTION -->
        <title>fencing - Admin Panel</title>            
...
<script src="//cdn.jsdelivr.net/npm/alertifyjs@1.11.2/build/alertify.min.js"></script>
    ...
    <body onload="getAssignLocationData()">
        ...
        <div class="page-container">
             ...
             <?php include "./header.php";?>    
                ...
                <div class="page-content-wrap container">
                            ...
                            <i class="fa fa-location-arrow"></i>   fencing Detail's
                            <span style="float:right;margin-right:10px;">
                              <a href="javascript:void(0)" onclick="window.open('./addAssignLocation.php','_blank')" class="text-decoration:none;" title="Assign Location" data-toggle="tooltip" data-placement="bottom">
        ...
        <script>
   function getAssignLocationData(){
        $.ajax({
                url:"getAssignLocation.php",
                success:function(data){
                    $("#assignLocationData").html(data);
                }
        });  
   }    
  
        // delete employee
           function deleteAssignLocation(assign_location_id){
                $.ajax({
                    url:"./deleteAssignLocation.php?assign_location_id="+assign_location_id,
                    success:function(data){
                          if(data==="Success"){                                   
